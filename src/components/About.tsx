            ...
            <Modal isOpen={isOpen} onClose={onClose}>
                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        ...
                        <Text>Developed by <Link href={"https://github.com/mahbd/"} isExternal>Mahmudul
                            Alam</Link></Text>
                        <Heading as={"h2"} size={"md"}>About</Heading>
                        <p>Room Components is a tool to help you find and organize different element in your room.</p>
                        <Heading as={"h2"} size={"md"}>How to use</Heading>
                        <UnorderedList>
